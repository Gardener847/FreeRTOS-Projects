...
bool terminalTask::taskEntry()
{
    ...
    // Task Resume and Suspend handlers
    cp.addHandler(taskCtrl, "taskctrl", "Suspend and Resume tasks");
    ...
    // cp.addHandler(task1Cmd, "suspend task", "Use to suspend a task");
    // cp.addHandler(task2Cmd, "resume task", "Use to resume a task");
